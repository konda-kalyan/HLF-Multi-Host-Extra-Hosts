...
docker exec "$CLI_NAME" peer chaincode instantiate -o "$ORDERER_NAME":7050 -C "$CHANNEL_NAME" -l java -n "$COUCHDB_JAVA_CC_NAME" "$COUCHDB_JAVA_CC_SRC" -v v0  -c '{"Args":["init", "0", "init_name", "init_dept", "5", "init_loc"]}' -P "AND('Org1MSP.peer', 'Org2MSP.peer', 'Org3MSP.peer' )" --tls true --cafile $ORDERER_CA
...
docker exec "$CLI_NAME" peer chaincode invoke -o "$ORDERER_NAME":7050 --tls true --cafile $ORDERER_CA -C $CHANNEL_NAME -n $COUCHDB_JAVA_CC_NAME --peerAddresses $PEER0_ORG1_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG1_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG2_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG2_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG3_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG3_TLS_ROOT_CERT_FILE_PATH -c '{"Args":["addEmployee","1", "Kalyan", "Blockchain", "100", "Hyd"]}'
sleep 10

docker exec "$CLI_NAME" peer chaincode invoke -o "$ORDERER_NAME":7050 --tls true --cafile $ORDERER_CA -C $CHANNEL_NAME -n $COUCHDB_JAVA_CC_NAME --peerAddresses $PEER0_ORG1_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG1_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG2_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG2_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG3_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG3_TLS_ROOT_CERT_FILE_PATH -c '{"Args":["addEmployee","2", "Fabric", "Hyperledger", "1004", "Delhi"]}'
sleep 10

docker exec "$CLI_NAME" peer chaincode invoke -o "$ORDERER_NAME":7050 --tls true --cafile $ORDERER_CA -C $CHANNEL_NAME -n $COUCHDB_JAVA_CC_NAME --peerAddresses $PEER0_ORG1_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG1_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG2_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG2_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG3_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG3_TLS_ROOT_CERT_FILE_PATH -c '{"Args":["addEmployee","3", "Kalyan", "Blockchain", "15", "Hyd"]}'
sleep 10

docker exec "$CLI_NAME" peer chaincode invoke -o "$ORDERER_NAME":7050 --tls true --cafile $ORDERER_CA -C $CHANNEL_NAME -n $COUCHDB_JAVA_CC_NAME --peerAddresses $PEER0_ORG1_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG1_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG2_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG2_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG3_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG3_TLS_ROOT_CERT_FILE_PATH -c '{"Args":["addEmployee","4", "Konda", "Fabric", "10003", "Blr"]}'
...
# ================================
docker exec "$CLI_NAME" peer chaincode invoke -o "$ORDERER_NAME":7050 --tls true --cafile $ORDERER_CA -C $CHANNEL_NAME -n $COUCHDB_JAVA_CC_NAME --peerAddresses $PEER0_ORG1_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG1_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG2_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG2_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG3_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG3_TLS_ROOT_CERT_FILE_PATH -c '{"Args":["queryEmployee", "1"]}'

# ================================
# RICH QUERY: queryEmpBySalaryGreaterThanXAmount - Parameterized rich query
# ================================
docker exec "$CLI_NAME" peer chaincode invoke -o "$ORDERER_NAME":7050 --tls true --cafile $ORDERER_CA -C $CHANNEL_NAME -n $COUCHDB_JAVA_CC_NAME --peerAddresses $PEER0_ORG1_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG1_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG2_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG2_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG3_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG3_TLS_ROOT_CERT_FILE_PATH -c '{"Args":["queryEmpBySalaryGreaterThanXAmount", "100"]}'

# ================================
# RICH QUERY: queryEmployees - Ad hoc rich query (query employees by name)
# ================================
docker exec "$CLI_NAME" peer chaincode invoke -o "$ORDERER_NAME":7050 --tls true --cafile $ORDERER_CA -C $CHANNEL_NAME -n $COUCHDB_JAVA_CC_NAME --peerAddresses $PEER0_ORG1_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG1_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG2_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG2_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG3_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG3_TLS_ROOT_CERT_FILE_PATH -c '{"Args":["queryEmployees", "{\"selector\":{\"empName\":\"Kalyan\"}, \"use_index\":[\"_design/empNameIndexDoc\", \"empNameIndex\"]}"]}'

# ================================
# QUERING CHAINCODE - Normal regular query (query employees by given empIDs range)
# ================================
docker exec "$CLI_NAME" peer chaincode invoke -o "$ORDERER_NAME":7050 --tls true --cafile $ORDERER_CA -C $CHANNEL_NAME -n $COUCHDB_JAVA_CC_NAME --peerAddresses $PEER0_ORG1_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG1_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG2_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG2_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG3_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG3_TLS_ROOT_CERT_FILE_PATH -c '{"Args":["queryEmpsByGivenEmpIDRange", "0", "3"]}'
...
# ================================
docker exec "$CLI_NAME" peer chaincode invoke -o "$ORDERER_NAME":7050 --tls true --cafile $ORDERER_CA -C $CHANNEL_NAME -n $COUCHDB_JAVA_CC_NAME --peerAddresses $PEER0_ORG1_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG1_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG2_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG2_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG3_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG3_TLS_ROOT_CERT_FILE_PATH -c '{"Args":["queryEmpBySalaryGreaterThanXAmountWithPagination", "1", "3", ""]}'

# ================================
# INVOKING CHAINCODE - Update employee
# ================================
docker exec "$CLI_NAME" peer chaincode invoke -o "$ORDERER_NAME":7050 --tls true --cafile $ORDERER_CA -C $CHANNEL_NAME -n $COUCHDB_JAVA_CC_NAME --peerAddresses $PEER0_ORG1_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG1_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG2_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG2_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG3_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG3_TLS_ROOT_CERT_FILE_PATH -c '{"Args":["updateEmployee", "1", "Raja", "AI", "89", "Bvrm"]}'
sleep 10

# ================================
# INVOKING CHAINCODE - Update employee
# ================================
docker exec "$CLI_NAME" peer chaincode invoke -o "$ORDERER_NAME":7050 --tls true --cafile $ORDERER_CA -C $CHANNEL_NAME -n $COUCHDB_JAVA_CC_NAME --peerAddresses $PEER0_ORG1_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG1_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG2_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG2_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG3_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG3_TLS_ROOT_CERT_FILE_PATH -c '{"Args":["updateEmployee", "1", "Tinku", "Some", "59", "Pkl"]}'
sleep 10
...
# ================================
docker exec "$CLI_NAME" peer chaincode invoke -o "$ORDERER_NAME":7050 --tls true --cafile $ORDERER_CA -C $CHANNEL_NAME -n $COUCHDB_JAVA_CC_NAME --peerAddresses $PEER0_ORG1_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG1_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG2_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG2_TLS_ROOT_CERT_FILE_PATH --peerAddresses $PEER0_ORG3_ADDRESS:7051 --tlsRootCertFiles $PEER0_ORG3_TLS_ROOT_CERT_FILE_PATH -c '{"Args":["getHistoryForKey", "1"]}'
